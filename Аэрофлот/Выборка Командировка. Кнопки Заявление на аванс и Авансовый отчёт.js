// Кнопка показывается только если для текущего сотрудника (curUserID) уже существует соответствующий документ (cc_advance_statement / cc_expense_report) по этой командировке
