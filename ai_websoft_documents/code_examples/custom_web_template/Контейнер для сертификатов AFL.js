...
function documentButton(curObject, sDownloadLink) {
...
function isDocumentView(elem) {
  try {
    if (elem.name == 'certificate') {
      return true;
    }
  } catch (err) {
      ...
      <ul class="documents_list">
        ...
        if (isDocumentView(elem)) {
                ...
                <li class="document <%=elem.name%>">
                    ...
                    <%
                        actionButton = documentButton(curObject, sDownloadLink);
                    ...
                    <div class="document__buttons">
                        ...
                        <%
                                ...
                                //ВЫВОД ПФ В ЗАЯВКЕ
                                if (curObject.request_type_id.ForeignElem.code == 'afl_certificate') {
                                  if (curObject.custom_elems.GetOptChildByKey('certificate') != undefined) {
                                    docCertificate = tools.open_doc(curObject.custom_elems.GetOptChildByKey('certificate').value);
                                    if (docCertificate != undefined) {
                                      oSignature = ArrayOptFirstElem(docCertificate.TopElem.signature_files);
