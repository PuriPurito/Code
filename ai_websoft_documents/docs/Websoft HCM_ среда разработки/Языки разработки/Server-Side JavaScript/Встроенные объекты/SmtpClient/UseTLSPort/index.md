...
Выполняет подключение унифицированного порта TLS (протокола защиты транспортного уровня) при отправке электронного почтового сообщения (если параметр настройки TLS имеет значение _'bUseTLSPort'_).

_Синтаксис:_  
      **SmtpClient.UseTLSPort**

_Возвращаемое значение:_  
      Производится подключение унифицированного порта TLS. Возвращаемое значение отсутствует.
