...
Атрибут объекта MailboxReader .  
Формирует объект MailMessage, который содержит очередное электронное сообщение, полученное с сервера.

_Синтаксис:_  
      **MailboxReader.Message**

_Возвращаемое значение:_  
      Тип: **Объект MailMessage**. Объект, который содержит очередное электронное сообщение, полученное с сервера.
