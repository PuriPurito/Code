...
Помечает текущее сообщение как прочитанное.

_Синтаксис:_  
      **MailboxReader.MarkMessageAsRead ()**

_Аргументы:_  
      Функция вызывается без аргументов.

_Возвращаемое значение:_  
      Текущее сообщение помечается как прочитанное. Возвращаемое значение отсутствует.
