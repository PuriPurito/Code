...
Чтение очередного (следующего) сообщения с почтового сервера.

_Синтаксис:_  
      **MailboxReader.ReadNextMessage ()**

_Аргументы:_  
      Функция вызывается без аргументов.

_Возвращаемое значение:_  
      Производится считывание очередного сообщения с почтового сервера в объект MailboxReader, из которого данный метод был вызван. Возвращаемое значение отсутствует.
